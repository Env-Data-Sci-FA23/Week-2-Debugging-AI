...
3\. Added "color" to species body mass plot

4\. Adelie species was spelled incorrectly

5\. Wrote filtered Adelie data to an object called "adalie" so they box plot code would run
