...
1.  palmerpenguins data package not loaded

2.  tidyverse package not loaded

3.  added color = species for geom_point

4.  Adelie misspelled in filter

5.  the object 'adelie' doesn't exist
