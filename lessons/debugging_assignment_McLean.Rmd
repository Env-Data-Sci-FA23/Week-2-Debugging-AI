...
1.  Need to install palmer penguins with install.packages("palmerpenguins") then load it in with library(palmerpenguins)

2. Need to install the tidyverse

3.  Scatterplot needs color added by species to differentiate them 

4.  Adelie is spelled wrong

5.  New df named Adelie can be created

6. Need to add ", echo=FALSE" to code chunks to hide them and match them to the sample HTML
