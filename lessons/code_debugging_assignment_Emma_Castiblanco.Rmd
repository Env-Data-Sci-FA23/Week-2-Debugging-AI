...
1.  Install and use library function for all necessary packages

2.  Needed to change echo= TRUE to echo =FALSE

3.  Need to add color for ggplot

4.  Name new df 'adelie'

5.  Adelie was misspelled
